(function (ActionAppCore, $) {
   ...
   */
    ...
    actions.readQRCode = readQRCode;
    function readQRCode() {
      ThisPage.common.pendingStage = ThisPage.common.currentStage 
      gotoStage('readcode');
      setRole('');
    }
   ...
   */
    ...
    function gotoStage(theStage) {
      ThisPage.common.currentStage = theStage;
      ThisPage.showSubPage({
    ...
    function refreshUI() {
      ...
      var tmpHostStatus = '<div class="ui message compact">Waiting for host ...</div>';
      tmpHostStatus += '<div class="pad5"></div><div pageaction="readQRCode" class="ui button blue compact">Use Code / QR Code To Connect</div>'
